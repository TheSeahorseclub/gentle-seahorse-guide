  ...
  "rounded-2xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        soft: "bg-muted/50 border-transparent",
        ocean: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground border-transparent",
        sunrise: "bg-gradient-to-br from-secondary to-accent border-transparent",
